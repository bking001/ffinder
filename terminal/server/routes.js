...
exports.connect = function connect(req, res) {
  ...
  if (req.method === 'POST' && req.body.username && req.body.userpassword && req.body.ena) {
    req.session.username      = req.body.username;
    req.session.ena           = req.body.ena;
    req.session.Devtype       = req.body.type;
    req.session.userpassword  = req.body.userpassword;
    req.session.userip        = req.body.userip;
    req.session.Clientuser    = req.body.user;
    req.session.DevUrl        = req.params.host;
