...
class MonitoringAntennaDbm extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:monitoring-antenna-dbm';
    ...
    public function handle()
    {
        ...
        foreach ($Dbm as $key => $value) 
        {
           ...
           if(!empty($AntennaIp))
           {
                ...
                TaskMonitoring::ANTENNA_DBM($secIp,$creds->username,$creds->password,$value->user_id,$value->task_id,$AntennaIp);
           }
