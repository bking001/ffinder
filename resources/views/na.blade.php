<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="w-11/12 mx-auto" style="max-height: 1200px; overflow-y: auto;display:block;"> 
            ...
            <form class="max-w-md mx-left"   method="get" action="{{ route('NASearch') }}" >
                @csrf
                <div class="flex">
    ...
    {
        let result = localStorage.getItem('successNAMessage');
        if (result)
        {
            showNotification('Done', 'Onu operation done successfully','success',3);
            localStorage.removeItem('successNAMessage');
        }
    };

    function NADelete(Type,ip,ifindex,descr,onuMac,key)
    {
    ...
    function Delete_ONU()
    {
        ...
        $.ajax({
                ...
                { 
                    ...
                    {        
                        localStorage.setItem('successNAMessage', true);
                        location.reload();
                    }
                },
